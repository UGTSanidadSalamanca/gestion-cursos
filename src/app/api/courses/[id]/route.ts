    ...
    try {
        ...
        const course = await db.course.update({
            ...
            data: {
                ...
                durationPeriod,
                syllabusUrl,
                minStudents: typeof minStudents === 'string' ? (minStudents ? parseInt(minStudents) : null) : minStudents,
                maxStudents: typeof maxStudents === 'string' ? (maxStudents ? parseInt(maxStudents) : null) : maxStudents,

  ...
  try {
    ...
    const duplicated = await db.course.create({
      data: {
        ...
        availableForNonMembers: original.availableForNonMembers,
        hasDiscounts: original.hasDiscounts,
        discountDescription: original.discountDescription,
        discountRules: original.discountRules,
        hasOffer: original.hasOffer,
        offerTitle: original.offerTitle,
